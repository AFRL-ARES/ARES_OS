...
{
  public class StageControllerGetYPositionCommand : AresDeviceCommand<double>
  {
    public override ConstrainedValue<double> Constraints { get; set; } = new StageControllerYPositionConstraint();
    ...
    public override bool Validate(string[] args)
    {
      ...
      if (double.TryParse(args[0], out var yPos))
      {
        return true;
      }
