...
{
  public class StageControllerStepNorthWestCommand : AresDeviceCommand<double>
  {
    public override ConstrainedValue<double> Constraints { get; set; } = new StageControllerStepNorthWestConstrainedValue();
