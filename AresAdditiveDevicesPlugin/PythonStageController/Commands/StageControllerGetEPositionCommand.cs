...
{
  public class StageControllerGetEPositionCommand : AresDeviceCommand<double>
  {
    public override ConstrainedValue<double> Constraints { get; set; } = new StageControllerXPositionConstraint();
    ...
    public override bool Validate(string[] args)
    {
      ...
      if (double.TryParse(args[0], out var ePos))
      {
        return true;
      }
