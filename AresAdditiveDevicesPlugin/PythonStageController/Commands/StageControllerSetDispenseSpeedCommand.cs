...
{
  internal class StageControllerSetDispenseSpeedCommand : AresDeviceCommand<double>
  {
    public override ConstrainedValue<double> Constraints { get; set; }
    public override double Value { get; set; }
    public override string ScriptName { get; } = "SET_DISPENSE_SPEED";
    public override string PlanValueString { get; set; } = "VAL_DISPENSE_SPEED";
    public override bool IsPlannable { get; set; } = true;
    public override int ArgCount { get; } = 1;
    public override string HelpString { get; } = "Sets the python configuration value for dispense speed";
    ...
    public override async Task Execute(string[] lines)
    {
      ...
      await stageController.WritePyDict("dispenser.speed", value);
    }
