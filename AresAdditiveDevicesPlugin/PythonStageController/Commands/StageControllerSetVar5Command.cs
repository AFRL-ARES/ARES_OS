...
{
  public class StageControllerSetVar5Command : AresDeviceCommand<double>
  {
    public override ConstrainedValue<double> Constraints { get; set; } = new StageControllerSetVar5ConstrainedValue();
    public override double Value { get; set; }
    public override string ScriptName { get; } = "SET_VAR5";
    public override string PlanValueString { get; set; } = "VAL_VAR5";
    public override bool IsPlannable { get; set; } = true;
    public override int ArgCount { get; } = 1;
    public override string HelpString { get; } = "Sets the python configuration value for custom variable 5";
    ...
    public override async Task Execute(string[] lines)
    {
      ...
      await stageController.WritePyDict("uservars.var5", value);
    }
