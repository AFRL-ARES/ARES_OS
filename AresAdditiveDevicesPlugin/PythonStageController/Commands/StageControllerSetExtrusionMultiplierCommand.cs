...
{
  public class StageControllerSetExtrusionMultiplierCommand : AresDeviceCommand<double>
  {
    public override ConstrainedValue<double> Constraints { get; set; } = new StageControllerSetExtrusionMultiplierConstrainedValue();
    public override double Value { get; set; }
    public override string ScriptName { get; } = "SET_EXTRUSION_MULTIPLIER";
    public override string PlanValueString { get; set; } = "VAL_EXTRUSION_MULTIPLIER";
    public override bool IsPlannable { get; set; } = true;
    public override int ArgCount { get; } = 1;
    public override string HelpString { get; } = "Sets the python configuration value for extrusion multiplier";
    ...
    public override async Task Execute(string[] lines)
    {
      ...
      await stageController.WritePyDict("dispenser.multiplier", value);
    }
