...
{
  public class StageControllerStepSouthWestCommand : AresDeviceCommand<double>
  {
    public override ConstrainedValue<double> Constraints { get; set; } = new StageControllerStepSouthWestConstrainedValue();
