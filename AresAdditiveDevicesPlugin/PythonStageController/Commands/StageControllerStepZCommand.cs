...
{
  public class StageControllerStepZCommand : AresDeviceCommand<double>
  {
    public override ConstrainedValue<double> Constraints { get; set; } = new StageControllerStepZConstrainedValue();
