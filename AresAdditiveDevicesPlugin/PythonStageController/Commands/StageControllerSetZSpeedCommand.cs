...
{
  public class StageControllerSetZSpeedCommand : AresDeviceCommand<int>
  {
    public override ConstrainedValue<int> Constraints { get; set; } = new StageControllerZSpeedConstraint();
