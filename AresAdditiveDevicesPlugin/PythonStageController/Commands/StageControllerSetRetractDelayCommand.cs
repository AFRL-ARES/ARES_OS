...
{
  public class StageControllerSetRetractDelayCommand : AresDeviceCommand<double>
  {
    public override ConstrainedValue<double> Constraints { get; set; } = new StageControllerSetRetractDelayConstrainedValue();
    public override double Value { get; set; }
    public override string ScriptName { get; } = "SET_RETRACT_DELAY";
    public override string PlanValueString { get; set; } = "VAL_RETRACT_DELAY";
    ...
    public override async Task Execute(string[] lines)
    {
      ...
      await stageController.WritePyDict("dispenser.retract_delay", value);
    }
