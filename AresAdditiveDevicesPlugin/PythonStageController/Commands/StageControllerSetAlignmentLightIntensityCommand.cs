...
{
  public class StageControllerSetAlignmentLightIntensityCommand : AresDeviceCommand<int>
  {
    public override ConstrainedValue<int> Constraints { get; set; } = new StageControllerAlignmentLightIntensityConstraint();
