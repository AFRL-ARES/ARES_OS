...
{
  public class StageControllerStepSouthEastCommand : AresDeviceCommand<double>
  {
    public override ConstrainedValue<double> Constraints { get; set; } = new StageControllerStepSouthEastConstrainedValue();
