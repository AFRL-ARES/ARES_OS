...
{
  public class StageControllerSetPrimeDelayCommand : AresDeviceCommand<double>
  {
    public override ConstrainedValue<double> Constraints { get; set; } = new StageControllerSetPrimeDelayConstrainedValue();
    public override double Value { get; set; }
    public override string ScriptName { get; } = "SET_PRIME_DELAY";
    public override string PlanValueString { get; set; } = "VAL_PRIME_DELAY";
    public override bool IsPlannable { get; set; } = true;
    public override int ArgCount { get; } = 1;
    public override string HelpString { get; } = "Sets the python configuration value for prime delay";
    ...
    public override async Task Execute(string[] lines)
    {
      ...
      await stageController.WritePyDict("dispenser.prime_delay", value);
    }
