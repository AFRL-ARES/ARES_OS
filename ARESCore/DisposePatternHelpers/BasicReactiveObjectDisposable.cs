...
{
  /// <summary>
  /// Abstract class that inherits from <see cref="ReactiveObject"/>  and implements <see cref="IBasicReactiveObjectDisposable"/>.
  /// This also provides a container for adding <see cref="IDisposable"/>s to that will be cleaned up when disposed.
  /// </summary>
  public abstract class BasicReactiveObjectDisposable : Errorable, IBasicReactiveObjectDisposable
  {
